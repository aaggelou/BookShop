...
<%
	...
	if(request.getParameter("categoryId")!=null && request.getParameter("categoryId").isEmpty()==false){
		String categoryId = request.getParameter("categoryId");
		
		Client client= Client.create();
		WebResource webResource = client.resource("http://localhost:8080/BookShopApp/rest/BookShopAppService/ShowProducts/"+categoryId);
		...
		JSONArray test2 = mainObj2.getJSONArray("product");
...
%>
  ...
  <div class="card">
    <img class="card-img-top" src="data:image/<%out.print(test2.getJSONObject(i).getString("productImageType"));%>;base64, <%out.print(test2.getJSONObject(i).getString("productImage"));%>" alt="Card image" style="width:100%">
    <div class="card-body">
      <h4 class="card-title"><%out.print(test2.getJSONObject(i).getString("productName"));%></h4>
      <p class="card-text">Τιμή: <%out.print(test2.getJSONObject(i).getString("productPrice"));%> &euro;</p>
	  <br><br>
    <a href="productsdetails.jsp?productId=<%out.print(test2.getJSONObject(i).getString("productId"));%>" class="btn btn-primary">Περισσότερα</a>
    
    
    <%--  <form ACTION="productsdetails.jsp" METHOD="POST">
       <input id="title" type="text" name="productId" value="<%out.print(test2.getJSONObject(i).getString("productId"));" style="display:none;" />
       
	    <button  class="btn btn-primary" name="product_btn" type="submit">Περισσότερα</button>
	   </form >--%>
    </div>
  </div>
  </div>
   ...
   <%}
    ...
    <div class="list-group">
        <a href="#" class="list-group-item list-group-item-action">
            ...
            <p>Δεν υπάρχουν προϊόντα για την συγκεκριμένη κατηγορία. Παρακαλούμε επέλεξε μία διαφορετική κατηγορία από την αρχική σελίδα!</p>
        </a>
    ...
    <div class="list-group">
        <a href="#" class="list-group-item list-group-item-action">
            <div class="d-flex w-100 justify-content-between">
              ...
              <img class="photo" src="pictures/mesaage.png" alt="info" style="width:25%">
            <p>Για να δεις ένα προϊόν πρέπει να επιλέξεις μία κατηγορία προϊόντος. Παρακαλούμε επέλεξε μία κατηγορία από την αρχική σελίδα!</p>
        </a>
