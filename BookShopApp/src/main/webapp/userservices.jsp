...
<div class="container">
  ...
  <div class="card">
    <img class="card-img-top" src="pictures/buy.png" alt="Card image" style="width:100%">
    <div class="card-body">
      <h4 class="card-title">Ιστορικό Αγορών</h4>
      <p class="card-text">Δες το ιστορικό αγορών σου!</p>
	  <br><br>
      <a href="myhistory.jsp" class="btn btn-primary">Περισσότερα</a>
    </div>
  </div>
  </div>
  <br>
   ...
   <div class="col-md-6 col-lg-4 col-xl-4">
  <div class="card">
    <img class="card-img-top" src="pictures/newletter.png" alt="Card image" style="width:100%">
    <div class="card-body">

      <h4 class="card-title">Διαχείριση Newsletters!</h4>
      <p class="card-text">Εγγράψου και απεγγράψου από τα Newsletters!</p>
	  <br>
      <a href="newsletter.jsp" class="btn btn-primary">Περισσότερα</a>
    </div>
  </div>
  </div>
  <br>
   ...
   <div class="col-md-6 col-lg-4 col-xl-4">
  <div class="card">
    <img class="card-img-top" src="pictures/delete.png" alt="Card image" style="width:100%">
    <div class="card-body">
      <h4 class="card-title">Διαγραφή Λογαριασμού</h4>
      <p class="card-text">Διέγραψε τον λογαριασμό σου! Η συγκεκριμένη ενέργεια είναι οριστική!</p>
      <br>
      <a href="deleteuser.jsp" class="btn btn-primary">Περισσότερα</a>
    </div>
  </div>
  </div>
  <br>
   ...
   <div class="row">
    <div class="col-md-6 col-lg-4 col-xl-4">
  <div class="card">
    <img class="card-img-top" src="pictures/wishlist.png" alt="Card image" style="width:100%">
    <div class="card-body">
      <h4 class="card-title">WishList</h4>
      <p class="card-text">Διαζειρίσου την WishList σου!</p>
	  <br><br>
      <a href="Wishlist.jsp" class="btn btn-primary">Περισσότερα</a>
    </div>
  </div>
  </div>
  <br>
   ...
   <div class="col-md-6 col-lg-4 col-xl-4">
  <div class="card">
    <img class="card-img-top" src="pictures/source_minions.png" alt="Card image" style="width:100%">
    <div class="card-body">
  ...
  <br>
   ...
   <div class="col-md-6 col-lg-4 col-xl-4">
  <div class="card">
    <img class="card-img-top" src="pictures/source (6).png" alt="Card image" style="width:100%">
    <div class="card-body">
      <h4 class="card-title">Καμπάνιες Δωρεάς</h4>
      <p class="card-text">Επειδή αγάπη σημαίνει να μοιράζεσαι!</p>
      <br><br>
      <a href="campaign.jsp" class="btn btn-primary">Περισσότερα</a>
    </div>
  </div>
  </div>
  <br>
