...
<%}
	...
	WebResource webResource = client.resource("http://localhost:8080/BookShopApp/rest/BookShopAppService/ShowWishList/");
...
JSONArray test2 = mainObj2.getJSONArray("wishlist");
%>
...
%>
  ...
  <div class="card">
    ...
    <div class="card-body">
	  ...
	  <br><br>
	   <form name="removewishlist" action="useraction.jsp" method="POST">
               <input type="text"  id="wishlistId"  name="wishlistId"   style="display:none;" value="<%out.print(test2.getJSONObject(i).getString("wishlistId"));%>"/>
                <input type="text"  id="userId" name="userId"   style= "display:none;" value="<%out.print(test2.getJSONObject(i).getString("userId")); %>">
            	    <p> <button id="bcolor" class="btn" type="submit" name="removewishlist" >Remove from WishList <i class="fa fa-heart"></i></button></p>
            	    </form>
    ...
    <div class="list-group">
        <a href="#" class="list-group-item list-group-item-action">
            <div class="d-flex w-100 justify-content-between">
                <h4>Άδεια WishList!</h4>
                <small>info message</small>
            </div>
              <img class="photo" src="pictures/mesaage.png" alt="info" style="width:25%">
            <p>Δεν έχεις προσθέσει κάποιο προϊόν στην WishList σου! Πρόσθεσε τα αγαπημένα σου προϊόντα επιλέγοντάς τα από τις κατηγορίες!</p>
        </a>
