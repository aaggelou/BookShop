...
<%
	...
	if(request.getParameter("search")!=null ){
		...
		WebResource webResource = client.resource("http://localhost:8080/BookShopApp/rest/BookShopAppService/Search/");
		
		MultivaluedMap <String,String> formData = new com.sun.jersey.core.util.MultivaluedMapImpl();
		
		formData.add("searchText", searchText);
		...
		JSONArray test2 = mainObj2.getJSONArray("search");
   ...
   <%}
    ...
    <div class="list-group">
        <a href="#" class="list-group-item list-group-item-action">
            ...
            <p>Δεν υπάρχουν προϊόντα για τον συγκεκριμένο όρο αναζήτησης. Παρακαλούμε εισάγετε έναν διαφορετικό όρο!</p>
        </a>
