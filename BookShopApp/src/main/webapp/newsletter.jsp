...
<%}
	...
	WebResource webResource = client.resource("http://localhost:8080/BookShopApp/rest/BookShopAppService/GetNewsletterData/");
...
<div id="demo" class="carousel slide" data-ride="carousel">
  ...
  <div class="carousel-inner">
    <div class="carousel-item active">
      <img src="pictures/newsletter.jpeg" alt="Newsletter" width="1100" height="500">
    ...
    <div class="list-group">
        <a href="#" class="list-group-item list-group-item-action">
            <div class="d-flex w-100 justify-content-between">
                <h4>Ενεργοποιημένα Newsletters!</h4>
                <small>info message</small>
            </div>
              <img class="photo" src="pictures/newslettersactivated.jpg" alt="info" style="width:25%">
            <p>Τα Nesletters σου είναι ενεργοποιημένα. Εάν θες να τα απενεργοποιήσεις κάνε click παρακάτω!</p>
        </a>
        
    </div>
</div>
<br> <br>
  <form name="modifyn" action="useraction.jsp" method="POST">
    <div class="form-group">
    
      <input type="text"  id="username1"  name="username1" style= "display:none"; value="<%out.println(username1); %>">
       <input type="text"  id="nstatus"  name="nstatus" style= "display:none"; value="no">
    </div>
    
    
    <button type="submit" class="btn btn-primary" name="modify_news">Ναι θέλω να τα απενεργοποιήσω</button>
  </form>
<%}
    ...
    <div class="list-group">
        <a href="#" class="list-group-item list-group-item-action">
            <div class="d-flex w-100 justify-content-between">
                <h4>Μη ενεργοποιημένα Newsletters!</h4>
                <small>info message</small>
            </div>
              <img class="photo" src="pictures/news.png" alt="info" style="width:25%">
            <p>Τα Nesletters σου είναι απνεργοποιημένα. Εάν θες να τα ενεργοποιήσεις κάνε click παρακάτω!</p>
        </a>
...
<br> <br>	
 <form name="modifyn" action="useraction.jsp" method="POST">
    <div class="form-group">
      ...
      <input type="text"  id="username1"  name="username1" style= "display:none"; value="<%out.println(username1); %>">
        <input type="text"  id="nstatus"  name="nstatus" style= "display:none"; value="yes">
    </div>
    
    
    <button type="submit" class="btn btn-primary" name="modify_news">Ναι θέλω να τα ενεργοποιήσω</button>
  </form>	
...
<%}
    ...
    <div class="list-group">
        <a href="#" class="list-group-item list-group-item-action">
            <div class="d-flex w-100 justify-content-between">
                <h4>Μη ενεργά Newsletters!</h4>
                <small>info message</small>
            </div>
              <img class="photo" src="pictures/news.png" alt="info" style="width:25%">
            <p>Κάποιο πρόβλημα υπήρξε. Τα Newsletter δεν είναι ενεργά στον λογαριασμό σου.</p>
        </a>
