<%@ page language="java" contentType="text/html; charset=UTF-8"
   ...
   <% 
	...
	WebResource webResource = client.resource("http://localhost:8080/BookShopApp/rest/BookShopAppService/ShowCategories/");
...
JSONArray test2 = mainObj2.getJSONArray("category");
%>
...
%>
  ...
  <div class="card">
    <img class="card-img-top" src="data:image/<%out.print(test2.getJSONObject(i).getString("categoryType"));%>;base64, <%out.print(test2.getJSONObject(i).getString("categoryImage"));%>" alt="Card image" style="width:100%">
    <div class="card-body">
      <h4 class="card-title"><%out.print(test2.getJSONObject(i).getString("categoryName"));%></h4>
      <p class="card-text"><%out.print(test2.getJSONObject(i).getString("categoryDescription"));%></p>
	  <br><br>
    <a href="products.jsp?categoryId=<%out.print(test2.getJSONObject(i).getString("categoryId"));%>" class="btn btn-primary">Περισσότερα</a>
     <%--   <form ACTION="products.jsp" METHOD="POST">
       <input id="title" type="text" name="categoryId" value="<%out.print(test2.getJSONObject(i).getString("categoryId"));%>" style="display:none;" />
       <input id="title" type="text" name="categoryName" value="<%out.print(test2.getJSONObject(i).getString("categoryName"));%>" style="display:none;" />
	    <button  class="btn btn-primary" name="category_btn" type="submit">Περισσότερα</button>
	   </form >--%>
    </div>
  </div>
  </div>
